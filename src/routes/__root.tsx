...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    ...
    links: [
      ...
      { rel: "preconnect", href: "https://mmwxluyvqdiqzrazjwky.supabase.co", crossOrigin: "anonymous" },
      {
        rel: "stylesheet",
  ...
  return (
    <html lang="en">
      <head>
        <HeadContent />
        {/* Google tag (gtag.js) */}
        <script async src="https://www.googletagmanager.com/gtag/js?id=AW-18120801457"></script>
        <script
