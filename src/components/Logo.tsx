  ...
  return (
    <div className={`flex min-w-0 items-center gap-2.5 sm:gap-3.5 ${className ?? ""}`}>
      ...
      <div className="min-w-0 leading-tight">
        ...
        <div className={`text-[7px] uppercase tracking-[0.16em] transition-all duration-300 ease-out max-[380px]:hidden sm:text-[9px] sm:tracking-[0.3em] lg:text-[10px] ${light ? "text-primary-glow drop-shadow-[0_1px_10px_rgba(0,0,0,0.5)]" : "text-primary"}`}>
