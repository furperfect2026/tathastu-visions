...
// Insert after the email div:
// <div className="sm:col-span-2">
//   <Label htmlFor="email" ... >Email</Label>
//   <Input id="email" ... />
// </div>

const parts = code.split('<Label htmlFor="interest"');
if (parts.length === 2) {
  const newCode = parts[0] + cityDropdown.trim() + '\n                <div className="sm:col-span-2">\n                  <Label htmlFor="interest"' + parts[1];
  fs.writeFileSync('src/components/ContactSection.tsx', newCode);
  console.log('Inserted City dropdown in ContactSection');
} else {
