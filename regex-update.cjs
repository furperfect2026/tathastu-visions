...
code = code.replace(
  /<div className="sm:col-span-2">\s*<Label htmlFor="interest"/g,
  cityDropdown + '                <div className="sm:col-span-2">\n                  <Label htmlFor="interest"'
);

fs.writeFileSync('src/components/ContactSection.tsx', code);
console.log('Successfully inserted City dropdown via regex.');
